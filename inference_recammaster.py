...
class TextVideoCameraDataset(torch.utils.data.Dataset):
    ...
    def normalize_intrinsics(self, intri):
    ...
    def get_relative_pose(self, cam_params):
        ...
        ret_poses = [target_cam_c2w, ] + [abs2rel @ abs_c2w for abs_c2w in abs_c2ws[1:]] # 列表加！！
    ...
    def __getitem__(self, data_id):
        ...
        intri_path = self.cam_intri_path[data_id]
        ...
        # pose_embedding = rearrange(pose_embedding, 'b c d -> b (c d)') # 21x12
...
if __name__ == '__main__':
    ...
    for batch_idx, batch in enumerate(dataloader):
        ...
        target_camera = batch["camera"] # (1, 81, 4, 4)
        ...
        video = pipe(
            ...
            seed=0, tiled=True, intrinsics=intrinsics
        )
