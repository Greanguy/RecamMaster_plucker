...
#     pipeline.output.save_artifacts=true
# python process_video.py /data1/home/liu_kai/RecamMaster_plucker/evaluate/vipe/vipe_res_cam01/pose --cam cam01
...
#     pipeline.output.save_artifacts=true
# python process_video.py /data1/home/liu_kai/RecamMaster_plucker/evaluate/vipe/vipe_res_cam05/pose --cam cam05
...
#     pipeline.output.save_artifacts=true
# python process_video.py /data1/home/liu_kai/RecamMaster_plucker/evaluate/vipe/vipe_res_cam07/pose --cam cam07